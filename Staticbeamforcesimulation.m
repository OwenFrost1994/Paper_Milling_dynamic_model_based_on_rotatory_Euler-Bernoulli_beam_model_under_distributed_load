...
subplot(2,1,1)
plot(Fm(n3:n4,1),F(1,n1:n2),'b-','Markersize',7,'Markerface','white','linewidth',2.0);%%这里要注意F是3×N,读取的数据是N×4
hold on;
plot(Fm(n3:n4,1),Fs(1,n1:n2),'b-.','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
plot(Fm(n3:n4,1),Fm(n3:n4,2),'b--','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
grid on;
...
set(get(gca,'XLabel'),'Fontsize',20)
set(get(gca,'YLabel'),'Fontsize',20)
legend('Proposed model','Static model','Measured')
subplot(2,1,2)
plot(Fm(n3:n4,1),F(2,n1:n2),'r-','Markersize',7,'Markerface','white','linewidth',3.0);
hold on;
plot(Fm(n3:n4,1),Fs(2,n1:n2),'r-.','Markersize',7,'Markerface','white','linewidth',2.0);
hold on;
plot(Fm(n3:n4,1),Fm(n3:n4,3),'r--','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
grid on;
xlim([min(Fm(n3:n4,1)) max(Fm(n3:n4,1))])
xlabel('time(s)')
...
plot(Fm(n3:n4,1),Fs(1,n1:n2),'b-.','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
plot(Fm(n3:n4,1),Fb(:,1),'b--','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
grid on;
xlim([min(Fm(n3:n4,1)) max(Fm(n3:n4,1))])
xlabel('time(s)')
...
set(get(gca,'XLabel'),'Fontsize',20)
set(get(gca,'YLabel'),'Fontsize',20)
legend('Proposed model','Static model','Balanced')
subplot(2,1,2)
plot(Fm(n3:n4,1),F(2,n1:n2),'r-','Markersize',7,'Markerface','white','linewidth',3.0);
hold on;
plot(Fm(n3:n4,1),Fs(2,n1:n2),'r-.','Markersize',7,'Markerface','white','linewidth',2.0);
hold on;
plot(Fm(n3:n4,1),Fb(:,2),'r--','Markersize',7,'Markerface','white','linewidth',1.0);
hold on;
grid on;
xlim([min(Fm(n3:n4,1)) max(Fm(n3:n4,1))])
xlabel('time(s)')
